	...
	<section class="mt-4 px-5">
		<div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
			<div class="col-md-6 px-0">
				<h1 class="display-4">
					Welcome, <i>Dr. ${doctor.getLastName()}</i> !
				</h1>
				<p class="lead mb-0">
					<a href="updatedoctor" class="text-white font-weight-bold">Edit My Profile</a>
		...
		<div
			...
			<div align="center">
				...
				&nbsp; &nbsp; <a class="btn btn-info" href="#">Update Patient Record</a> <br>
				<br> <a class="btn btn-warning" href="findprescriptions">Look up Prescription</a>
