...
<title>MedSearch: Update Doctor Profile</title>
</head>
<body>
<nav class="navbar navbar-expand-sm navbar-light bg-light">
	...
	<section class="mt-4 px-5">
		...
		<p>${success}</p>
		<a class="btn btn-secondary" href="adminlogout">Login Again »</a>
